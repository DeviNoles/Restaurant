...
class App extends Component {
  ...
  addToOrder = (key) => {
    ...
    const newTotal = this.state.orderTotal + FoodList[key].price;
  ...
  removeFromOrder = (key) => {
    ...
    let newTotal = this.state.orderTotal - (FoodList[key].price);

    if(order[key] === 0) {
      newTotal = this.state.orderTotal - FoodList[key].price;
      delete order[key];
    }
